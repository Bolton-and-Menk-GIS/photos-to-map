...
<head>
    ...
    <script type="text/javascript">
		/* This uses the OverlappingMarkerSpiderfier plugin to handle overlapping markers.  More info here:
			https://github.com/jawj/OverlappingMarkerSpiderfier

		***Much of this code was adopted from the sample Spiderfier app***
		*/
		// clog up global namespace, have fun :)
		var oms, map, locations;
		locations = points;
        function initialize() {
        ...
        function setMarkers(map, oms, locations) {
...
# compiled OverlappingMarkerSpidifier plugin to handle clustering
# https://github.com/jawj/OverlappingMarkerSpiderfier
oms = """(function(){/*
